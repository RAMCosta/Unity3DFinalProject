...
public class TCPDestinos : MonoBehaviour
{
    ...
    string DirValor;
    string EsqValor;
    public static Boolean Tempo2s;
    Matlab_TempoDet MatlabTempo;
    ...
    void Update()
    {
        ...
        if (Tcpheli.conectado == true)
        {
            ...
            if (Matlab_TempoDet.IsChecked == true)
            {
                tempoDet = (distancia - 100) / Velocidade;
                Debug.Log(tempoDet + "Test");
                if (tempoDet <= 2)
                {
